(() => {
  ...
  $(document).ready(function() {
    if (frappe.boot.fc_communication_secret && frappe.boot.setup_complete === 1 && !frappe.is_mobile() && frappe.user.has_role("System Manager")) {
      frappe.call({
        ...
        callback: function(r) {
          ...
          if (message.login_token) {
            ...
            frappe.msgprint({
              ...
              )} <a href="${frappeCloudBaseEndpoint}/api/method/press.api.developer.saas.login_to_fc?token=${message.login_token}" target="_blank">${__("Click here to login")}</a></p>`
            });
          } else {
...
//# sourceMappingURL=billing.bundle.WRPJPUSH.js.map
