(() => {
  ...
  frappe.views.ReportView = class ReportView extends frappe.views.ListView {
    ...
    is_editable(df, data) {
      return df && frappe.model.can_write(this.doctype) && (data.docstatus !== 1 || df.allow_on_submit) && data.docstatus !== 2 && !df.read_only && !df.is_virtual && !df.hidden && frappe.model.is_non_std_field(df.fieldname) && df.read_only_depends_on && !this.evaluate_read_only_depends_on(df.read_only_depends_on, data);
    }
    get_data(values) {
  ...
  // frappe-html:/home/aeroplane/frappe-bench/apps/frappe/frappe/public/js/frappe/views/reports/print_grid.html
...
`;
  ...
  // frappe-html:/home/aeroplane/frappe-bench/apps/frappe/frappe/public/js/frappe/views/reports/print_tree.html
...
`;
  ...
  // frappe-html:/home/aeroplane/frappe-bench/apps/frappe/frappe/public/js/frappe/ui/group_by/group_by.html
...
//# sourceMappingURL=report.bundle.HY55HVKU.js.map
